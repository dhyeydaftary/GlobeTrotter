...
export const CardSkeleton = () => (
  <div className="bg-surface-card rounded-card shadow-card border border-border-light overflow-hidden flex flex-col justify-between h-[380px]">
...
export const RecommendationSkeleton = () => (
  <div className="min-w-[220px] bg-surface-card rounded-card shadow-card border border-border-light overflow-hidden p-4 space-y-3 shrink-0">
